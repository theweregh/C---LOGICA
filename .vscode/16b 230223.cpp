//16b 23/02/23 cual es el mayor y menor numero entre grupos de numeros asignados por el usuarop(el usuario va asignando numeros repetidamente mientras ingrese numeros positivos)
#include <iostream>
using namespace std;
int main(){
    ...
    */
    ...
    //if para guardar el menor absoluto
    if(mna==0){
        mna=mn;
    }
    else{
    ...
    cout<<"\nel numero menor absoluto es "<<mna;
    cout<<"\nel promedio es "<<p;
    return 0;
}